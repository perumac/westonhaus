  ...
  <footer class="footer">
    ...
    <div class="container">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Weston Haus LLC. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
...
<style scoped>
.footer {
  background: linear-gradient(180deg, var(--color-bg-darker) 0%, #0a0a0a 100%);
  position: relative;
  padding: 6rem 0 3rem;
