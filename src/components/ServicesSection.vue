...
.service-card:hover {
  ...
  box-shadow: 0 25px 50px rgba(0, 0, 0, 0.5), 0 0 20px rgba(212, 175, 55, 0.08);
...
.card-overlay {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(to top, var(--color-bg-dark) 0%, rgba(18,18,18,0.2) 60%, transparent 100%);
  opacity: 0.9;
}
